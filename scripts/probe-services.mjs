...
const response=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/${process.env.LLM_MODEL}:generateContent`,{
 ...
 body:JSON.stringify({contents:[{parts:[{text:'Reply with exactly OK.'}]}],generationConfig:{maxOutputTokens:30,thinkingConfig:{thinkingBudget:0}}}),signal:AbortSignal.timeout(20000)
});
